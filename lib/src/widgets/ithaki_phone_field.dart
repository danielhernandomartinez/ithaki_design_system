...
class _IthakiPhoneFieldState extends State<IthakiPhoneField> {
  ...
  void _validate() {
    ...
    final isValid = digits.length >= _country.minDigits &&
        digits.length <= _country.maxDigits;
    setState(() {
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color:
                  _showError ? IthakiTheme.errorRed : IthakiTheme.borderLight,
